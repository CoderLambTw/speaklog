/* ============================================================
   Icons — inline Lucide SVG(零依賴,stroke 繼承 currentColor)
...
const Icons = (() => {
  ...
  function svg(name, size = 18, cls = '') {
    const p = PATHS[name];
    if (!p) return '';
    return `<svg class="lucide${cls ? ' ' + cls : ''}" width="${size}" height="${size}" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">${p}</svg>`;
  }
